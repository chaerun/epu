...
<section class="vbox">
	<section class="scrollable padder">
		<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
			...
			<li><a href="${pageContext.request.contextPath}/participantjourney/precreate/${journey.id}/"><spring:message code="participant.journey.add" /></a></li>
			<li class="active"><spring:message code="participant.journey.delete" /></li>
		</ul>
		<div class="m-b-md">
			<h3 class="m-b-none">
				<spring:message code="participant.journey.delete" />
			</h3>
		</div>
		...
		<section class="panel panel-default">
			...
			<div class="panel-body">
				<form:form cssClass="form-horizontal" action="${pageContext.request.contextPath}/participantjourney/delete" modelAttribute="participantJourney" autocomplete="off">
					<form:hidden path="id" />
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-4 col-sm-offset-2">
							<a href="${pageContext.request.contextPath}/participantjourney/precreate/${journey.id}/" class="btn btn-default"><spring:message code="cancel" /></a>
