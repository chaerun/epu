...
<section class="vbox">
	<section class="scrollable padder">
		<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
			...
			<li><a href="${pageContext.request.contextPath}/moderator/precreate/${journey.id}/"><spring:message code="moderator.journey.add" /></a></li>
			<li class="active"><spring:message code="moderator.journey.view.detail" /></li>
		</ul>
		<div class="m-b-md">
			<h3 class="m-b-none">
				<spring:message code="moderator.journey.view.detail" />
			</h3>
		</div>
				...
				<form action="" class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-sm-4 col-sm-offset-2">
							<a href="${pageContext.request.contextPath}/moderator/precreate/${journey.id}/" class="btn btn-default"><spring:message code="back" /></a>
						</div>
					</div>
				</form>
			</div>
