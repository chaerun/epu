...
<section class="vbox">
	<section class="scrollable padder">
		<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
			...
			<li class="active"><spring:message code="position.create" /></li>
		</ul>
		<div class="m-b-md">
			<h3 class="m-b-none">
		...
		<section class="panel panel-default">
			...
			<div class="panel-body">
				<form:form cssClass="form-horizontal" action="${pageContext.request.contextPath}/position/create" modelAttribute="position" autocomplete="off">
