...
<section class="vbox">
	<section class="scrollable padder">
		<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
			...
			<li><a href="${pageContext.request.contextPath}/receipt/activity/${activity.code }/"><spring:message code="receipt.list" /></a></li>
			<li class="active"><spring:message code="receipt.create" /></li>
		</ul>
		<div class="m-b-md">
			<h3 class="m-b-none">
		...
		<section class="panel panel-default">
			...
			<div class="panel-body">
				<form:form cssClass="form-horizontal" action="${pageContext.request.contextPath}/receipt/create" modelAttribute="receipt" autocomplete="off">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label font-bold"><spring:message code="receipt.amount" /></label>
						<div class="col-sm-10">
							<p class="form-control-static">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label font-bold"><spring:message code="receipt.description" /></label>
						<div class="col-sm-10">
							<p class="form-control-static">${receipt.description}</p>
						</div>
					</div>
