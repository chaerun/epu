...
<section class="vbox">
	<section class="scrollable padder">
		<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
			...
			<li class="active"><spring:message code="balance.list" /></li>
		</ul>
		<div class="m-b-md">
			<h3 class="m-b-none">
				<spring:message code="balance.list" /> = <fmt:formatNumber value="${total }" currencySymbol="Rp." pattern="¤ #,##0.00;¤ -#,##0.00" />
			</h3>
		</div>
		<jsp:include page="/WEB-INF/views/message.jsp" />
		<section class="panel panel-default">
			<header class="panel-heading">
				<a class="btn btn-primary" href="${pageContext.request.contextPath}/balance/precreate"><i class="fa fa-plus-square"></i> <spring:message code="balance.create" /> </a>
			</header>
		</section>
		<section class="panel panel-default">
			<header class="panel-heading">
			...
			<div class="panel-body">
				<form:form cssClass="form-horizontal" action="${pageContext.request.contextPath}/balance" modelAttribute="dateFilter" autocomplete="off">
		...
		<section class="panel panel-default">
			<header class="panel-heading">
				<spring:message code="balance.list" />
			</header>
			<div class="panel-body">
				<display:table id="balance" class="table table-striped" name="page" sort="external" partialList="true" size="${page.fullListSize}" pagesize="${page.objectsPerPage}" requestURI="" export="true">
					<display:column property="createdDate" titleKey="balance.date" sortable="true" format="{0,date,MM/dd/yyyy HH:mm:ss}" />
					<display:column property="description" titleKey="balance.description" />
