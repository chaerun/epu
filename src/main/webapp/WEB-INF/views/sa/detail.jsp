...
<section class="vbox">
	<section class="scrollable padder">
		<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
			...
			<li><a href="${pageContext.request.contextPath}/sa/pendingcomplete"><spring:message code="journey.list" /></a></li>
				...
				<form class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-sm-4 col-sm-offset-2">
							<a href="${pageContext.request.contextPath}/sa/pendingapprove/${journey.id}/" class="btn btn-danger" onclick="return confirm('Lanjutkan ?');"><spring:message code="approve" /></a>
						</div>
					</div>
				</form>
			</div>
